...
<?php echo form_open(); ?>
    ...
    <?php echo form_input('name',set_value('name',$emp->name),array(
        'id' => 'employee_name',
        'required' => 'required'
    ));?>
    ...
    <?php echo form_input('ssn',set_value('ssn',$emp->tin),array(
        'id' => 'employee_ssn',
        'required' => 'required'
    ));?>
    ...
    <?php echo form_input('tin',set_value('tin',$emp->ssn),array(
        'id' => 'employee_tin',
        'required' => 'required'
    ));?>
